...
<?php else: ?>
    <div style="text-align: center; width: 100%; padding: 40px;">
        ...
        <p>Please check back later for upcoming events and festivals.</p>
    </div>
<?php endif; ?>
</div>
...
<script>
  ...
  <?php if(isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true): ?>
    <div class="admin-panel">
      ...
      <div class="admin-section">
        <h4>Add New Event</h4>
        <form action="admin/add_event.php" method="POST" enctype="multipart/form-data" class="event-form">
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="text" id="event_time" name="event_time" placeholder="e.g., 8:00 AM - 12:00 PM" required>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="text" id="event_location" name="location" placeholder="Enter event location" required>
            </div>
            <div class="form-group">
          ...
          <div class="form-row">
            <div class="form-group">
              <label for="date_day">Date Day:</label>
              <input type="text" id="date_day" name="date_day" placeholder="e.g., 15" maxlength="2">
            </div>
            <div class="form-group">
              <label for="date_month">Date Month:</label>
              <input type="text" id="date_month" name="date_month" placeholder="e.g., Jan" maxlength="3">
            </div>
          </div>
          
          <div class="form-group">
            <label for="short_description">Description:</label>
            <textarea id="short_description" name="short_description" placeholder="Enter event description" required rows="4"></textarea>
          </div>
          
          <div class="form-row">
            <div class="form-group">
              <label for="register_link">Register Link (Optional):</label>
              <input type="url" id="register_link" name="register_link" placeholder="https://...">
            </div>
            <div class="form-group">
              <label for="donate_link">Donate Link (Optional):</label>
              <input type="url" id="donate_link" name="donate_link" placeholder="https://...">
            </div>
          </div>
      ...
      <div class="admin-section">
        <h4>Manage Existing Events</h4>
        <div class="admin-events-list">
          <?php 
          $events_result = $conn->query("SELECT * FROM events ORDER BY created_at DESC");
          if ($events_result && $events_result->num_rows > 0): 
          ?>
            <?php while ($event = $events_result->fetch_assoc()): ?>
              <div class="admin-event-item" data-event-id="<?php echo $event['id']; ?>">
                <div class="admin-event-info">
                  <h5><?php echo htmlspecialchars($event['title']); ?></h5>
                  <p><strong>Time:</strong> <?php echo htmlspecialchars($event['event_time']); ?></p>
                  <p><strong>Location:</strong> <?php echo htmlspecialchars($event['location']); ?></p>
                  <p><strong>Date:</strong> <?php echo htmlspecialchars($event['date_day'] . ' ' . $event['date_month']); ?></p>
                </div>
                <div class="admin-event-actions">
                  <button class="edit-event-btn" onclick="editEvent(<?php echo $event['id']; ?>)">
                    <i class="fas fa-edit"></i> Edit
                  </button>
                  <form action="admin/delete_event.php" method="POST" class="delete-event-form">
                    <input type="hidden" name="event_id" value="<?php echo $event['id']; ?>">
                    <button type="submit" class="delete-event-btn" onclick="return confirm('Are you sure you want to delete this event?');">
  ...
  <div class="edit-event-modal" id="edit-event-modal">
    <div class="edit-event-content">
      ...
      <form action="admin/edit_event.php" method="POST" enctype="multipart/form-data" class="edit-event-form">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="text" id="edit_event_time" name="event_time" required>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="file" id="edit_event_image" name="event_image" accept="image/*">
        ...
        <div class="form-row">
          <div class="form-group">
            <label for="edit_date_day">Date Day:</label>
            <input type="text" id="edit_date_day" name="date_day" maxlength="2">
          </div>
          <div class="form-group">
            <label for="edit_date_month">Date Month:</label>
            <input type="text" id="edit_date_month" name="date_month" maxlength="3">
          </div>
        </div>
        
        <div class="form-group">
          <label for="edit_short_description">Description:</label>
          <textarea id="edit_short_description" name="short_description" required rows="4"></textarea>
        </div>
        
        <div class="form-row">
          <div class="form-group">
            <label for="edit_register_link">Register Link (Optional):</label>
            <input type="url" id="edit_register_link" name="register_link">
          </div>
          <div class="form-group">
            <label for="edit_donate_link">Donate Link (Optional):</label>
            <input type="url" id="edit_donate_link" name="donate_link">
          </div>
        </div>
        
        <div class="form-actions">
          <button type="submit" class="admin-btn">Update Event</button>
          <button type="button" class="admin-btn" style="background: #6c757d;" onclick="closeEditModal()">Cancel</button>
        </div>
      </form>
    </div>
  </div>
  ...
  justify-items: center;
    ...
    .edit-event-modal.active .edit-event-content {
      transform: translateY(0);
    }
  ...
  <script>
    ...
    function editEvent(eventId) {
      // Fetch event data
      fetch(`admin/get_event.php?event_id=${eventId}`)
        ...
        .then(data => {
          if (data.success) {
            ...
            document.getElementById('edit_short_description').value = event.short_description;
            document.getElementById('edit_date_day').value = event.date_day || '';
            document.getElementById('edit_date_month').value = event.date_month || '';
            document.getElementById('edit_register_link').value = event.register_link || '';
            document.getElementById('edit_donate_link').value = event.donate_link || '';
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const addEventForm = document.querySelector('.event-form');
      if (addEventForm) {
