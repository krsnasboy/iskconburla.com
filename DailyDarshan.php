...
// Use the database connection from config.php if available
if (isset($conn) && $conn) {
    // Fetch YouTube URL from database
    $youtube_url = "";
    $sql = "SELECT youtube_url AS url FROM darshan_youtube ORDER BY updated_at DESC LIMIT 1";
    ...
    $sql = "SELECT image_path, caption FROM darshan_gallery ORDER BY uploaded_at DESC";
    ...
    // If no database connection, use empty arrays
    $youtube_url = "";
    $gallery_images = array();
}
?>
...
<a href="SevaRegd.html"><i class="fas fa-kitchen-set"></i> Cooking Seva</a>
<a href="SevaRegd.html"><i class="fas fa-broom"></i> Cleaning Seva</a>
<a href="SevaRegd.html"><i class="fas fa-book"></i> Book Distribution</a>
<a href="SevaRegd.html"><i class="fas fa-music"></i> Kirtan Seva</a>
<a href="VolunteerOpportunities.html"><i class="fas fa-hand-holding-heart"></i> Volunteer</a>
<a class="dropdown-login-btn" href="SevaRegd.html">Become Nitya sevak</a> <!-- Check this link again -->
</div>
</li>
<li class="dropdown">
...
<a href="DailyDarshan.html"><i class="fas fa-images"></i> Gallery</a>
...
<li><a href="SpiritualCounseling.html"><i class="fas fa-book-open"></i> Spiritual Counceling</a></li>
<li><a href="DailyDarshan.html"><i class="fas fa-video"></i> Gallery</a></li>
...
<!-- Main Content -->
<main>
    <section class="daily-darshan-section">
        <div class="container">
            <h1 class="section-title animate-on-scroll">Daily Darshan</h1>
            <p class="section-subtitle animate-on-scroll">Experience the divine presence of Lord Krishna through our live darshan</p>
            
            <!-- YouTube Live Section -->
            <div class="youtube-live-container animate-on-scroll">
                <div class="youtube-header">
                    <h2><i class="fas fa-video"></i> Live Darshan</h2>
                    <p>Join us for the daily darshan of the deities</p>
                </div>
                <div class="youtube-embed">
                    <?php if($youtube_url): ?>
                        <iframe src="https://www.youtube.com/embed/<?php echo extractYouTubeID($youtube_url); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <?php else: ?>
                        <div class="no-live-message">
                            <i class="fas fa-bell-slash"></i>
                            <p>Live darshan is currently offline. Please check back later.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="gallery-section animate-on-scroll">
                <div class="gallery-header">
                    <h2><i class="fas fa-images"></i> Darshan Gallery</h2>
                    <p>Moments of divine grace captured in time</p>
                </div>
    ...
    <?php if(isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true): ?>
        <div class="admin-panel">
            <div class="admin-header">
                <h3>Daily Darshan Admin Panel</h3>
                <a href="admin/logout.php" class="logout-btn">
                    <i class="fas fa-sign-out-alt"></i> Logout
                </a>
            </div>
            
            <!-- YouTube URL Update Form -->
            <div class="admin-section">
                <h4>Update YouTube Live URL</h4>
                <form action="admin/update_youtube.php" method="POST" class="youtube-form">
                    <div class="form-group">
                        <label for="youtube_url">YouTube URL:</label>
                        <input type="text" id="youtube_url" name="youtube_url" value="<?php echo $youtube_url; ?>" placeholder="https://www.youtube.com/watch?v=..." required>
                    </div>
                    <button type="submit" class="admin-btn">Update Live Stream</button>
                </form>
            </div>
            ...
            <div class="admin-section">
                ...
                <!-- Add New Image Form -->
                <form action="admin/upload_image.php" method="POST" enctype="multipart/form-data" class="upload-form">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="image_caption" name="image_caption" placeholder="Enter image caption" required>
                    </div>
                        ...
                        <div class="admin-gallery-grid">
                            <?php foreach($gallery_images as $index => $image): ?>
                                <div class="admin-gallery-item">
                                    <img src="<?php echo $image['image_path']; ?>" alt="Gallery Image <?php echo $index + 1; ?>">
                                    <div class="admin-image-actions">
                                        <form action="admin/delete_image.php" method="POST" class="delete-form">
                                    ...
                                    <div class="admin-image-caption"><?php echo htmlspecialchars($image['caption']); ?></div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
...
<li><a href="GauSeva.html"><i class="fas fa-cow"></i> Gau Seva</a></li>
<li><a href="VolunteerOpportunities.html"><i class="fas fa-hands-helping"></i> Volunteer</a></li>
</ul>
</div>
<div class="footer-column">
<h3>Resources and info</h3>
<ul>
<li><a href="javascript:void(0);"><i class="fas fa-book-open"></i> Bhagavad-gita</a></li>
<li><a href="javascript:void(0);"><i class="fas fa-book"></i>Srila Prabhupad Books</a></li>
<li><a href="BooksDistribution.html"><i class="fa-solid fa-y"></i>Youth Programs</a></li>
<li><a href="TempleActivities.html"><i class="fa-solid fa-people-roof"></i> Temple Activities</a></li>
</ul>
</div>
