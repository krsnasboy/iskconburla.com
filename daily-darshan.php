...
$images = $db->query('SELECT id, image_path, caption, uploaded_at FROM daily_darshan ORDER BY uploaded_at DESC, id DESC')->fetchAll();
...
<head>
  ...
  <title>Daily Darshan - ISKCON Portal</title>
  <?php render_public_head_assets(); ?>
  <link rel="stylesheet" href="/assets/css/daily-darshan.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body class="darshan-page">
<?php render_public_header(); ?>
<main>
  <div class="container">
    <div class="page-header animate__animated animate__fadeIn">
      <h2 class="page-title">Daily Darshan</h2>
      <div class="divider"></div>
      <p class="page-subtitle">Divine glimpses of the Lord's beautiful form</p>
    </div>
    
    <?php if ($flash): ?>
      <div class="alert <?php echo $flash['type']; ?> animate__animated animate__fadeInDown" data-flash>
        <div class="alert-content">
          <i class="fas <?php echo $flash['type'] === 'alert-success' ? 'fa-check-circle' : 'fa-exclamation-circle'; ?>"></i>
    ...
    <div class="gallery-section animate__animated animate__fadeInUp">
      <h3 class="gallery-title"><i class="fas fa-camera"></i> Gallery</h3>
      ...
      <?php else: ?>
        <?php foreach ($grouped_images as $date => $day_images): ?>
          <div class="date-group animate__animated animate__fadeInUp">
            <h4 class="date-header">
              <i class="fas fa-calendar-day"></i>
              <?php echo date('F j, Y', strtotime($date)); ?>
            </h4>
            <div class="img-grid">
              <?php foreach ($day_images as $img): ?>
                <figure class="card animate__animated animate__zoomIn">
                  <div class="image-wrapper">
                    <img src="<?php echo htmlspecialchars($img['image_path']); ?>" alt="Daily Darshan" loading="lazy">
                    <div class="image-overlay">
                      <button class="view-btn"><i class="fas fa-expand"></i></button>
                    </div>
                    <?php if ($img['caption']): ?>
                      <div class="caption-overlay">
                        <span class="caption-text"><?php echo htmlspecialchars($img['caption']); ?></span>
                      </div>
                    <?php endif; ?>
                  </div>
                </figure>
...
<style>
  ...
  /* Caption Overlay - Hover/Tap Only */
  .caption-overlay {
    position: absolute;
    bottom: 0;
    left: 0;
  ...
  @media (hover: none) and (pointer: coarse) {
    ...
    .card.touch-active .caption-overlay {
      opacity: 1;
      transform: translateY(0);
    }
  }
